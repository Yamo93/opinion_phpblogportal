...
?>
    ...
    <nav class="categories">
        <ul>
            ...
            <li><a href="#" class="active">Samhällsrelaterat</a></li>
        </ul>
    </nav>
    ...
    <div class="mainpage">
        <section class="mainpage__left">
            <h1 class="mainpage__title">De senaste blogginläggen inom ämnet <span>Samhällsrelaterat</span></h1>

            <?php 
                $result = $post->getPostsFromCategory(6, 5);
